...
public static class SystemConfigSeeder
{
    ...
    [
        ...
        new() { Key = "rag.semantic_min_tokens", Value = "72", DefaultValue = "72", Category = "Retrieval", DisplayName = "Semantic v2 minimum tokens", Description = "Estimated token minimum before semantic-v2 starts a new chunk.", ConfigType = "Number", IsCritical = true },
        new() { Key = "rag.semantic_max_tokens", Value = "192", DefaultValue = "192", Category = "Retrieval", DisplayName = "Semantic v2 maximum tokens", Description = "Hard estimated token ceiling for semantic-v2 chunks.", ConfigType = "Number", IsCritical = true },
        new() { Key = "rag.semantic_overlap_tokens", Value = "24", DefaultValue = "24", Category = "Retrieval", DisplayName = "Semantic v2 overlap tokens", Description = "Estimated token overlap between compatible semantic-v2 chunks.", ConfigType = "Number", IsCritical = true },
