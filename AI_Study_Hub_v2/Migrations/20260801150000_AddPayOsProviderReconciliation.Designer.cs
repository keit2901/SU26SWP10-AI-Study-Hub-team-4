                    ...
                    b.ToTable("payment_transactions", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_payment_transactions_provider_order_code_range", "provider_order_code IS NULL OR provider_order_code BETWEEN 1 AND 9007199254740991");

                            t.HasCheckConstraint("ck_payment_transactions_status", "status IN ('pending', 'completed', 'failed', 'demo_completed', 'refunded', 'expired', 'cancelled')");
                        });
                });
            ...
            modelBuilder.Entity("AI_Study_Hub_v2.Data.Entities.UserNotification", b =>
                {
                    ...
                    b.HasOne("AI_Study_Hub_v2.Data.Entities.User", "RecipientUser")
                        .WithMany()
